...
# 2. Fix ownership of FILE_PROXY_PATHS for the proxy handler (if ORIGIN_URL is configured)
...
# This runs after bootstrap so Composer finds a clean web root during install.
